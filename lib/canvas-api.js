...
exports.postGrade = (labNumber, studentName, score, comment) => {
  ...
  if(!isNumber.test(labNumber))return console.error('Lab must be a number');
...
exports.fetchSubmissionsOfEachLab = () => {
  Object.keys(canvasLabs).forEach((assn) => {
    ...
    .then(res => {
      ...
      // let submitted = studentSubmissions.filter(sub => sub.workflow_state === 'submitted');
...
//   })
// }
exports.showRemainingSubmissions = () => {
