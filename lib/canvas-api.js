...
exports.fetchCanvasStudents = (arg1, arg2, arg3, arg4, arg5) => {
  ...
  .then(() => exports.fetchSubmissionsOfEachLab(_linkAssnNameToSubmissions, _mapSubmissionsToStudents))
...
// exports.fetchUngradedLabs = () => {
//   return superagent.get(allLabsURL)
//   .set(canvasAuthHeader)
//   .then(res => {
//     console.log(allLabsURL);
//     res = res.body.filter(lab => lab.published);
//     console.log(res);
//     return res;
//   })
//   // .then(res => JSON.parse(res.text))
...
exports.fetchSubmissionsOfEachLab = (linkAssnNameToSubmissions, mapSubmissionsToStudents) => {
  Object.keys(canvasLabs).forEach((assn) => {
    ...
    .then(res => {
      ...
      // studentSubmissions = studentSubmissions.concat(res.body);
