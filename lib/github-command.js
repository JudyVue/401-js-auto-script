...
exports.fetchLabRepoURLs = () => {
  ...
  return superagent.get(`${ghURL}/repos`)
  ...
  .then((labName) => {
    console.log(labName, 'hit line 38?');
  ...
  .then((labName) => console.log('did something get passed', labName))
...
exports.cloneMainLabRepo = (url) => {
  ...
  .catch(() => {
    ...
    .then(() => {
      ...
      console.log(exports.labName, 'here?');
      return exports.labName;
    })
    .catch(() => {
...
//TODO: Why do you keep repeating the PR pulls twice????
